...
) -> Optional[Union[HTTPValidationError, Pump]]:
    if response.status_code == 200:
        response_200 = Pump.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, Pump]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (Pump): Model representing a pump actuator.
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, Pump]
    """
